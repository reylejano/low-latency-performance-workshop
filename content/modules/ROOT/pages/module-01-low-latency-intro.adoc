...
* Research from the Nielsen Norman Group states that "a 10-second delay will often make users leave a site immediately... Even a few seconds' delay is enough to create an unpleasant user experience."
